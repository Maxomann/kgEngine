...
namespace kg
{
	...
	public:
		cCamera( const sf::Vector2u finalSize );
		...
		//
		//If you give a Sprite instead of a ZValueDrawable, it will be drawn last
		void			draw( sf::Sprite& toDraw, int zValue );
